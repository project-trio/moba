...
<div class="chat-bar" :class="{ active: showingInput }">
	...
	<div class="chat-input-container">
		<button v-show="showingInput" :class="chatVisibilityClass" class="chat-visibility-button interactive" @click="onTeamVisibility">{{ allChat ? 'ALL' : 'team' }}</button>
		<input ref="chatInput" v-model.trim="draftMessage" class="chat-input" :class="{ active: showingInput }" @focus="onFocusChat" @blur="onBlurChat">
