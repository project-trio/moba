...
export default {
	...
	create () {
		...
		audioLoader.load(require('@/client/assets/sounds/bubble1.wav'), (buffer) => {
			respawnBuffer = buffer
		})
		audioLoader.load(require('@/client/assets/sounds/confirm1.wav'), (buffer) => {
			levelupBuffer = buffer
		})
		audioLoader.load(require('@/client/assets/sounds/select1.wav'), (buffer) => {
