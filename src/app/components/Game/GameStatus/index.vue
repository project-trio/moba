...
import HelpPanel from '@/app/components/Game/GameStatus/HelpPanel'
import PlayerScores from '@/app/components/Game/GameStatus/PlayerScores'
import SettingsPanel from '@/app/components/Game/GameStatus/SettingsPanel'
import TutorialPanel from '@/app/components/Game/GameStatus/Tutorial'
